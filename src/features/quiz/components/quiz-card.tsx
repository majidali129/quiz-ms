import { Award, Calendar, Clock, Copy, Edit, Eye, MoreHorizontal, Play, Trash2, Trophy, User } from "lucide-react";
...
export const QuizCard = async ({ quiz: { id, title, description, course, quizType, isActive, createdAt, passingScore, createdBy, startDate, quizDuration, difficulty, completionStatus } }: QuizItemProps) => {
                  ...
                  <>
                    {completionStatus === "completed" ? (
                      ...
                      <DropdownMenuItem>
                        ...
                        <span>{completionStatus === "in-progress" ? "Resume Quiz" : "Start Quiz"}</span>
                      </DropdownMenuItem>
                    )}
                    <DropdownMenuItem>
                      <Eye className="mr-2 h-4 w-4" />
